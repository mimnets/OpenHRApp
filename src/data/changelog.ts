...
export const changelog: ChangelogRelease[] = [
  {
    ...
    entries: [
      ...
      { type: 'feature', description: 'Added "Paste Markdown" button to RichTextEditor toolbar. Opens a modal where you can paste Markdown (including entire .md files with YAML frontmatter) — it converts to clean semantic HTML on insert. The converter automatically strips YAML frontmatter and the duplicate H1 title (since the blog post page already renders post.title as an h1, avoiding SEO-harmful duplicate h1 tags). Supports headings, bold, italic, code, links, images, ordered/unordered lists, blockquotes, and horizontal rules.' },
