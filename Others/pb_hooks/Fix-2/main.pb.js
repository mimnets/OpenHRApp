// pb_hooks/main.pb.js
// Optimized for multi-stage leave workflows with improved error handling
...
onRecordAfterCreateSuccess((e) => {
    ...
    try {
        // Use the application instance from the event for safer context
        const app = e.app || $app;
        const dao = app.dao();
        ...
        console.error("[LEAVE_CREATE] Hook Error: " + err.toString());
    }
}, "leaves");
